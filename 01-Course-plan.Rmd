...
Now, instead of deliver a mini coourse about VAR modeling, we are not going to deliver a **express**-mini-course on structural VAR models. Of course I need you help. You have to read completely the section [`"Express-course"`](https://perezp44.github.io/VAR-models-web/06-Express-course.html), a quick and **dirty** introduction to structural VAR models, and assits to the three on-line classes. 
