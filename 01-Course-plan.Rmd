...
The truth is that I would have preferred to delay the classes but finally we are going **to start the classes** as planned the **9th of April** at 9:00 (Spanish time, UTC + 2 hours), but on-line.
...
My topic (VAR models) was planned to be delivered in 5 sessions, starting the 9th of April. I think it is better to keep the official schedule, then, please see the [Schedule](https://perezp44.github.io/VAR-models-web/05-Schedule.html) section of the web.
...
Remember, that our first on-line meeting will be the **Thursday 9th of April at 9:00** (time of Spain, UTC+2 hours). You could find the date, time and more details about the on-line meetings in the [Schedule](https://perezp44.github.io/VAR-models-web/05-Schedule.html) section of the website
...
For several reasons, the most important is that the course was planed to be face-to-face and 5 sessions, but now we are on-line and there are 3 sessions left and the course has just started, then I have to change "the plan" for a "new plan".

Now, instead of deliver a mini coourse about VAR modeling, we are not going to deliver a **express**-mini-course on structural VAR models. Of course, I need still, even more, you help for the course works to make the course work. In particular you have to read completely the section [`"Express-course"`](https://perezp44.github.io/VAR-models-web/06-Express-course.html), a quick and **dirty** introduction to structural VAR models, and assits to the three on-line classes. 
...
<div class = "blue">
You should read the "Express-course" section of the web
</div>
